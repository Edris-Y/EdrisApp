        ...
        <div className="footer-grid">
          ...
          <div>
            ...
            <div className="social-row">
              ...
              {/* GitHub */}
              <a href="https://github.com/Edris-Y" target="_blank" rel="noreferrer" className="social-btn" aria-label="GitHub">
              ...
              {/* Email */}
              <a href="mailto:edris.youssef.pro@gmail.com" className="social-btn" aria-label="Email">
